...
public class WalkAlongMarkers : MonoBehaviour
{
    ...
    public GameObject babyStroller;
    ...
    void Update()
    {
        ...
        if (distance < markerDistance)
        {
            ...
            else
            {
                ...
                babyStroller.GetComponent<Animator>().SetTrigger("Stuck");
    ...
    IEnumerator PostProcess(float time)
    {
        yield return new WaitForSeconds(time);

        babyStroller.GetComponent<StrollWithMother>().enabled = false;
